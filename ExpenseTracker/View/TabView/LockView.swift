...
//  LockSwiftUIView
//
//  Created by Yasmin araujo on 29/04/2024.
//
...
struct LockView<Content: View>: View {
    ...
    private func unlockView() {
        ...
        Task {
            if isBiometriccAvailable && lockType != .number{
            ...
            // Undating Biometric status
            noBiometricAccess = !isBiometriccAvailable
        }
    }
    
    private var isBiometriccAvailable: Bool {
        ...
        VStack(spacing: 15) {
            Text("Enter Pin")
                ...
                .overlay(alignment: .leading) {
                    ...
                    if lockType == .both && isBiometriccAvailable {
                        Button(action: {
                            pin = ""
